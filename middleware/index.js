...
export const FontsConfig = {
  // Black: require("../assets/fonts/Comfortaa-Black.ttf"),
  Bold: require("../assets/fonts/Comfortaa-Bold.ttf"),
  // ExtraBold: require("../assets/fonts/Comfortaa-ExtraBold.ttf"),
  ...
  SemiBold: require("../assets/fonts/Comfortaa-SemiBold.ttf"),
};
